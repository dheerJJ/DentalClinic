  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] text-white rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 active:scale-95 animate-whatsapp group"
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-16 bg-surface-container-high border border-outline-variant/30 text-on-surface text-caption font-label-md px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-all duration-300 whitespace-nowrap shadow-md translate-x-2 group-hover:translate-x-0">
          Chat with Us
        </span>
      </a>
    </div>
